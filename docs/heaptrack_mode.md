...
After starting filelight, MemHawk will create a file with raw heaptrack data. Before ingesting it into the heaptrack GUI, data should be processed and symbolized. It can be done with the `heaptrack_interpret` utility.
